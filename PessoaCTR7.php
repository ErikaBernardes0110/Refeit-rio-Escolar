...
if(isset($_GET['apagar'])) {
    $pront = filter_input(INPUT_GET , 'apagar' , FILTER_SANITIZE_STRING);
      if(apagar_cozinheira($pront)){
        echo "<h3> Cozinheira Removida com Sucesso </h3>";
      }else{
        echo "<h3> Pessoa Não Removida</h3>";
      }
}
    ?>
            </center>
